...
//        singleRun();
        ...
        if (effMethodName.equals("e2")) {
            return (-1 * Statistics.nashSutcliffe(preArr, obsArr, 2, -9999));
        } else if (effMethodName.equals("e1")) {
            return (-1 * Statistics.nashSutcliffe(preArr, obsArr, 1, -9999));
        } else if (effMethodName.equals("le2")) {
            return (-1 * Statistics.nashSutcliffeLog(obsArr, preArr, 2));
        } else if (effMethodName.equals("pbias")) {
            return (Math.abs(Statistics.pbias(obsArr, preArr)));
        } else {
            return -9999;
        }
    }
